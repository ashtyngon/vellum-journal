      ...
      <div className="w-full max-w-md flex flex-col items-center">
        ...
        <div className="w-full bg-paper rounded-lg shadow-paper p-8 flex flex-col items-center gap-6 border border-wood-light/30">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border border-wood-light rounded-lg px-6 py-3 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all text-ink font-body font-medium"
          >
